...
import PatientReportTable from '../Table/PatientReportTable'

function PatientReportMainContent() {
    return (
        <div>
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold">Review Patient</h2>
...
export default PatientReportMainContent
